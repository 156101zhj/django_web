...
sys.path.insert(0,os.path.join(BASE_DIR, 'DjangoUeditor3'))
...
EMAIL_PORT = 25
EMAIL_HOST_USER = "15871442735@sina.cn"
EMAIL_HOST_PASSWORD = "15871442735zhj"
EMAIL_USE_TLS = False
EMAIL_FROM = "15871442735@sina.cn"
# 设置上传文件的路径
MEDIA_URL = '/media/'
