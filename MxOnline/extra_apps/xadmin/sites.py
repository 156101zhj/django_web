...
class AdminSite(object):
    ...
    def __init__(self, name='xadmin'):
        ...
        # url instance contains (url, admin_view class, name)
    ...
    def register_modelview(self, url, admin_view_class, name):
        from xadmin.views.base import BaseAdminView
        if issubclass(admin_view_class, BaseAdminView):
            self._registry_modelviews.append((url, admin_view_class, name))
        else:
    ...
    def register_view(self, url, admin_view_class, name):
        self._registry_views.append((url, admin_view_class, name))
    ...
    def get_urls(self):
        # from django.urls import include, url, url
        ...
        urlpatterns += [
            ...
            for _url, clz_or_func, name in self._registry_views
        ]
        ...
        for model, admin_class in iteritems(self._registry):
            view_urls = [
                ...
                for _url, clz, name in self._registry_modelviews
            ]
            urlpatterns += [
